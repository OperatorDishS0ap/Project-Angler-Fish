...
BATTERY_CUTOFF_V = float(os.environ.get("ANGLERFISH_BATTERY_CUTOFF_V", "6.2"))
BATTERY_CUTOFF_CLEAR_V = float(os.environ.get("ANGLERFISH_BATTERY_CUTOFF_CLEAR_V", "6.3"))
